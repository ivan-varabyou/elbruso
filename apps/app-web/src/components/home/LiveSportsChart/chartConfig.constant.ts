...
import { ChartType } from "./LiveSportsChart.smart";

// Все доступные типы диаграмм
export const ALL_CHARTS: ChartType[] = ["line", "bar", "grouped", "stacked", "pie"];

// Только базовые диаграммы
export const BASIC_CHARTS: ChartType[] = ["line", "bar", "pie"];

// Диаграммы для сравнения
export const COMPARISON_CHARTS: ChartType[] = ["bar", "grouped", "stacked"];

// Диаграммы для трендов
export const TREND_CHARTS: ChartType[] = ["line"];

// Диаграммы для распределения
export const DISTRIBUTION_CHARTS: ChartType[] = ["pie"];
