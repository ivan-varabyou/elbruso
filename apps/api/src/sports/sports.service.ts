...
export class SportsService implements OnModuleInit {
  ...
  async onModuleInit() {
    try {
      ...
      const mappings = [
        {
          names: ['Баскетбол', 'Волейбол', 'Футбол', 'Хоккей на траве', 'Гандбол', 'Регби', 'Бейсбол', 'Водное поло', 'Софтбол', 'Пляжный волейбол'],
          cat: 1, type: 1
        },
        {
          names: ['Бокс', 'Спортивная борьба', 'Велосипедный спорт', 'Гольф', 'Гребля на байдарках и каноэ', 'Гребной слалом', 'Гребной спорт', 'Дзюдо', 'Каратэ', 'Легкая атлетика', 'Плавание', 'Прыжки в воду', 'Прыжки на батуте', 'Пулевая стрельба', 'Стендовая стрельба', 'Стрельба из лука', 'Теннис', 'Триатлон', 'Тхэквондо', 'Тяжелая атлетика', 'Фехтование', 'Спортивная гимнастика', 'Художественная гимнастика', 'Современное пятиборье', 'Скалолазание', 'Скейтбординг', 'Серфинг'],
          cat: 1, type: 2
        },
        {
        ...
        {
          names: ['Биатлон', 'Горнолыжный спорт', 'Конькобежный спорт', 'Лыжное двоеборье', 'Лыжные гонки', 'Прыжки на лыжах с трамплина', 'Санный спорт', 'Фигурное катание на коньках', 'Фристайл', 'Сноуборд'],
          cat: 2, type: 2
        },
      ];

      // 1. Default all to None (4) / Individual (2)
      await sql`UPDATE sports SET olympic_category_id = 4, sport_type_id = 2`.execute(this.db.client);
