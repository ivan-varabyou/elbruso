                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-zinc-500 uppercase tracking-widest pl-1">Имя</label>
                                <input
                                    type="text"
                                    value={firstName}
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-zinc-500 uppercase tracking-widest pl-1">Фамилия</label>
                                <input
                                    type="text"
                                    value={lastName}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-zinc-500 uppercase tracking-widest pl-1">Отчество</label>
                            <input
                                type="text"
                                value={middleName}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-zinc-500 uppercase tracking-widest pl-1">Электронная почта</label>
                            <input
                                type="email"
                                value={user?.email || ''}
                                ...
                                readOnly
                            />
                            <p className="text-[10px] text-zinc-400 pl-1">Email не подлежит изменению пользователем</p>
                        </div>
                    </div>
