-- ================================
-- FINAL ROBUST UNIFIED INDICATORS LOAD
-- ================================
BEGIN;
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2031, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_NATIONAL_TEAM_M_U16', 'Сборная U16 (мужчины)', 'Члены мужской сборной России по легкой атлетике U16', 'number', (SELECT id FROM measurement_units WHERE code = 'people'), 0.2, 60, 1, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2201, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_PR_U16_M', 'Участие в ПР U16 (М)', 'Спортсмены региона в Первенстве России U16 (мужчины)', 'number', (SELECT id FROM measurement_units WHERE code = 'people'), 1.2, 60, 1, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2211, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_PR_U16_W', 'Участие в ПР U16 (Ж)', 'Спортсмены региона в Первенстве России U16 (женщины)', 'number', (SELECT id FROM measurement_units WHERE code = 'people'), 1.2, 60, 2, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2223, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_MEDAL_BRONZE_PR_U16_M', 'Бронза ПР U16 (М)', 'Бронзовые медали ПР U16 (мужчины)', 'number', (SELECT id FROM measurement_units WHERE code = 'medals'), 2.5, 60, 1, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2224, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_MEDAL_SILVER_PR_U16_M', 'Серебро ПР U16 (М)', 'Серебряные медали ПР U16 (мужчины)', 'number', (SELECT id FROM measurement_units WHERE code = 'medals'), 3.0, 60, 1, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2225, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_MEDAL_GOLD_PR_U16_M', 'Золото ПР U16 (М)', 'Золотые медали ПР U16 (мужчины)', 'number', (SELECT id FROM measurement_units WHERE code = 'medals'), 3.5, 60, 1, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2243, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_MEDAL_BRONZE_PR_U16_W', 'Бронза ПР U16 (Ж)', 'Бронзовые медали ПР U16 (женщины)', 'number', (SELECT id FROM measurement_units WHERE code = 'medals'), 2.5, 60, 2, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2244, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_MEDAL_SILVER_PR_U16_W', 'Серебро ПР U16 (Ж)', 'Серебряные медали ПР U16 (женщины)', 'number', (SELECT id FROM measurement_units WHERE code = 'medals'), 3.0, 60, 2, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, gender_id, age_group_id, use_population) VALUES (2245, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'ATH_MEDAL_GOLD_PR_U16_W', 'Золото ПР U16 (Ж)', 'Золотые медали ПР U16 (женщины)', 'number', (SELECT id FROM measurement_units WHERE code = 'medals'), 3.5, 60, 2, 60, TRUE)
ON CONFLICT (code) DO UPDATE SET
category_id = EXCLUDED.category_id,
name_ru = EXCLUDED.name_ru,
description = EXCLUDED.description,
