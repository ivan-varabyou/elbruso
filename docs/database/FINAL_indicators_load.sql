...
INSERT INTO indicator_catalog (category_id, code, name_ru, description, value_type, default_weight, sport_id, discipline_id, use_population, measurement_unit_id) VALUES ((SELECT id FROM indicator_categories WHERE code = 'infrastructure'), 'BBL_COURTS_INDOOR_5000', 'Крытые площадки 5000+ мест', 'Крытые площадки с трибунами на 5000+ зрителей', 'number', 0.25, 10, NULL, TRUE, (SELECT id FROM measurement_units WHERE code = 'площадок'))
ON CONFLICT (code) DO UPDATE SET
    category_id = EXCLUDED.category_id,
    name_ru = EXCLUDED.name_ru,
    description = EXCLUDED.description,
...
INSERT INTO indicator_catalog (id, category_id, code, name_ru, description, value_type, measurement_unit_id, default_weight, sport_id, discipline_id, gender_id, age_group_id, use_population) VALUES (1032, (SELECT id FROM indicator_categories WHERE code = 'achievements'), 'BBL_NATIONAL_TEAM_5X5_M_U16', 'Сборная 5х5 U16 (мужчины)', 'Члены мужской сборной России 5х5 U16', 'number', (SELECT id FROM measurement_units WHERE code = 'people'), 0.2, 10, 220, 1, 3, TRUE)
ON CONFLICT (code) DO UPDATE SET
    category_id = EXCLUDED.category_id,
    name_ru = EXCLUDED.name_ru,
    description = EXCLUDED.description,
