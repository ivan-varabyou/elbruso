...
import { BarChartConfig } from '@frontend/modules/visualization/lib';
import { HistogramAdapter } from '@frontend/modules/visualization/lib/adapters/HistogramAdapter';
