...
import { RidgelinePlotConfig } from '@frontend/modules/visualization/lib';
import { RidgelinePlotAdapter } from '@frontend/modules/visualization/lib/adapters/RidgelinePlotAdapter';
