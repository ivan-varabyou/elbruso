...
import { BubbleChartConfig } from '@frontend/modules/visualization/lib';
import { BubbleChartAdapter } from '@frontend/modules/visualization/lib/adapters/BubbleChartAdapter';
