...
import { CandlestickConfig } from '@frontend/modules/visualization/lib';
import { CandlestickAdapter } from '@frontend/modules/visualization/lib/adapters/CandlestickAdapter';
