...
import { ChoroplethMapConfig } from '@frontend/modules/visualization/lib';
import { ChoroplethMapAdapter } from '@frontend/modules/visualization/lib/adapters/ChoroplethMapAdapter';
