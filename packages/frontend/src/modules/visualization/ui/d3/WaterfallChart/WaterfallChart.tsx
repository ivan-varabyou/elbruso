...
import { WaterfallChartConfig } from '@frontend/modules/visualization/lib';
import { WaterfallChartAdapter } from '@frontend/modules/visualization/lib/adapters/WaterfallChartAdapter';
