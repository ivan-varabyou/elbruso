...
import { GeoHeatMapConfig } from '@frontend/modules/visualization/lib';
import { GeoHeatMapAdapter } from '@frontend/modules/visualization/lib/adapters/GeoHeatMapAdapter';
