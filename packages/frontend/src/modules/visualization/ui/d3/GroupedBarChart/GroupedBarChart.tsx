...
import { GroupedBarChartConfig } from '@frontend/modules/visualization/lib';
import { GroupedBarChartAdapter } from '@frontend/modules/visualization/lib/adapters/GroupedBarChartAdapter';
