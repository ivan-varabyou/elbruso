...
import { BubbleMapConfig } from '@frontend/modules/visualization/lib';
import { BubbleMapAdapter } from '@frontend/modules/visualization/lib/adapters/BubbleMapAdapter';
