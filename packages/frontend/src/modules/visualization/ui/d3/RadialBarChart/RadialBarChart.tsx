...
import { RadialBarChartConfig } from '@frontend/modules/visualization/lib';
import { RadialBarChartAdapter } from '@frontend/modules/visualization/lib/adapters/RadialBarChartAdapter';
