...
export const adminMenu: MenuItem[] = [
  ...
  {
    href: "#root-indicators",
    icon: TrendingUp,
    label: "Индикаторы",
    children: [
      { href: "/indicators", icon: TrendingUp, label: "Список индикаторов" },
      { href: "/indicators/groups", icon: Layers, label: "Группы индикаторов" },
      { href: "/indicators/templates", icon: FileType, label: "Шаблоны генерации" },
      { href: "/spreadsheets", icon: LayoutDashboard, label: "Шаблоны отчетов" },
    ],
  },
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                href: "/reference/data/federal_districts",
                icon: Flag,
          ...
          },
          {
            ...
            children: [
              ...
              {
                href: "/reference/data/measurement_units",
                icon: Ruler,
          ...
          },
          {
            ...
            children: [
              {
                href: "/reference/data/region_population",
                icon: Users,
                label: "Население регионов",
              },
              {
                href: "/reference/data/region_economics",
                icon: Coins,
          ...
          },
          {
            ...
            children: [
              ...
              {
                href: "/reference/data/sports_venues",
                icon: Building2,
