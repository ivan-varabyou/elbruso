...
> extends HttpClient<SecurityDataType> {
   ...
   * @secure
   */
  dynamicTablesControllerActivateVersion = (
    id: string,
   ...
   * @secure
   */
  dynamicTablesControllerDeleteRow = (
    id: string,
    index: number,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  dynamicTablesControllerInsertRow = (
    id: string,
    index: number,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  dynamicTablesControllerDeleteColumn = (
    id: string,
    index: number,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  dynamicTablesControllerInsertColumn = (
    id: string,
    index: number,
    params: RequestParams = {},
  ) =>
