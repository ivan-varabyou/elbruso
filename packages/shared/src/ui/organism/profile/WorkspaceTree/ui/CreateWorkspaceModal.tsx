...
export function CreateWorkspaceModal({ isOpen, onClose }: CreateWorkspaceModalProps) {
  ...
  useEffect(() => {
    if (isOpen && user) {
      fetchTemplates({
        sport_id: user.sport_id ? String(user.sport_id) : undefined,
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {templates.length === 0 ? (
                      ...
                      templates.map((t) => (
                        ...
                        >
                          ...
                          />
                          <div
                            className={`p-1.5 rounded-lg ${templateId === t.id ? "bg-white/10" : "bg-white shadow-sm"}`}
                          >
                            <Layout
                              className={`h-4 w-4 ${templateId === t.id ? "text-white" : "text-zinc-600"}`}
                            />
                          </div>
                          <div className="flex-1">
                            ...
                            <div
                              className={`text-[11px] ${templateId === t.id ? "text-zinc-400" : "text-zinc-500"}`}
                            >
                    ...
                    >
                      ...
                      />
                      <div
                        className={`p-1.5 rounded-lg ${!templateId ? "bg-white/10" : "bg-white shadow-sm"}`}
                      >
                        <Plus
                          className={`h-4 w-4 ${!templateId ? "text-white" : "text-zinc-600"}`}
                        />
                      </div>
                      <div className="flex-1">
                        <div className="text-[13px] font-bold leading-none mb-0.5">
                        ...
                        <div
                          className={`text-[11px] ${!templateId ? "text-zinc-400" : "text-zinc-500"}`}
                        >
