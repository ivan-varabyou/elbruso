...
export function SidebarHeader({ children, className }: SidebarHeaderProps) {
    return (
        <div className={cn('flex h-12 items-center justify-between px-3 border-b border-gray-100', className)}>
            {children}
        </div>
    );
}
...
export function SidebarFooter({ children, className }: SidebarFooterProps) {
    return (
        <div className={cn('border-t border-gray-100 px-2 py-2', className)}>
            {children}
        </div>
    );
}
