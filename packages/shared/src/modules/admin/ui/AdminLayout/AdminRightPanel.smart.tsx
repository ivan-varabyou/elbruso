...
export function AdminRightPanel({ isCollapsed, onToggle }: RightPanelProps) {
            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-zinc-50 border border-zinc-100 p-3">
                <p className="text-sm text-zinc-700 leading-relaxed">
                  Привет! Я AI-ассистент Elbruso. Могу помочь с созданием таблиц, заполнением
                  данных, построением графиков и предложением критериев оценки.
                </p>
              </div>
