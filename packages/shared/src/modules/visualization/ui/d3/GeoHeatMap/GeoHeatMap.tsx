...
import { GeoHeatMapConfig } from '@elbruso/modules/visualization/lib';
import { GeoHeatMapAdapter } from '@elbruso/modules/visualization/lib/adapters/GeoHeatMapAdapter';
