...
import { CalendarHeatmapConfig } from '@elbruso/modules/visualization/lib';
import { CalendarHeatmapAdapter } from '@elbruso/modules/visualization/lib/adapters/CalendarHeatmapAdapter';
