...
import { ParallelCoordinatesConfig } from '@elbruso/modules/visualization/lib';
import { ParallelCoordinatesAdapter } from '@elbruso/modules/visualization/lib/adapters/ParallelCoordinatesAdapter';
