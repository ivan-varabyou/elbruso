...
import { StreamGraphConfig } from '@elbruso/modules/visualization/lib';
import { StreamGraphAdapter } from '@elbruso/modules/visualization/lib/adapters/StreamGraphAdapter';
