...
import { ViolinPlotConfig } from '@elbruso/modules/visualization/lib';
import { ViolinPlotAdapter } from '@elbruso/modules/visualization/lib/adapters/ViolinPlotAdapter';
