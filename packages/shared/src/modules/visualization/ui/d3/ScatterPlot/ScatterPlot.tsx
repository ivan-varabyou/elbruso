...
import { ScatterChartConfig } from '@elbruso/modules/visualization/lib';
import { ScatterPlotAdapter } from '@elbruso/modules/visualization/lib/adapters/ScatterPlotAdapter';
