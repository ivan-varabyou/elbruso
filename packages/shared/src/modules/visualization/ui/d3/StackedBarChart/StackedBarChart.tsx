...
import { StackedBarChartConfig } from '@elbruso/modules/visualization/lib';
import { StackedBarChartAdapter } from '@elbruso/modules/visualization/lib/adapters/StackedBarChartAdapter';
