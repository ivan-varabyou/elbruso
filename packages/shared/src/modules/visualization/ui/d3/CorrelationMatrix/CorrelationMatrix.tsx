...
import { CorrelationMatrixConfig } from '@elbruso/modules/visualization/lib';
import { CorrelationMatrixAdapter } from '@elbruso/modules/visualization/lib/adapters/CorrelationMatrixAdapter';
