...
import { ChoroplethMapConfig } from '@elbruso/modules/visualization/lib';
import { ChoroplethMapAdapter } from '@elbruso/modules/visualization/lib/adapters/ChoroplethMapAdapter';
