...
import { CandlestickConfig } from '@elbruso/modules/visualization/lib';
import { CandlestickAdapter } from '@elbruso/modules/visualization/lib/adapters/CandlestickAdapter';
