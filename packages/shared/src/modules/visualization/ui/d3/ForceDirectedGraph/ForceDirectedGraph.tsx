...
import { ForceDirectedGraphConfig } from '@elbruso/modules/visualization/lib';
import { ForceDirectedGraphAdapter } from '@elbruso/modules/visualization/lib/adapters/ForceDirectedGraphAdapter';
