...
import { RidgelinePlotConfig } from '@elbruso/modules/visualization/lib';
import { RidgelinePlotAdapter } from '@elbruso/modules/visualization/lib/adapters/RidgelinePlotAdapter';
