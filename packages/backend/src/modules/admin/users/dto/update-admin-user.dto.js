...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['ADMIN', 'MODERATOR', 'SUPER_ADMIN'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['ADMIN', 'MODERATOR', 'SUPER_ADMIN']),
    __metadata("design:type", String)
...
], UpdateAdminUserDto.prototype, "is_active", void 0);
