...
let UsersController = class UsersController {
    ...
    async updateUserAdmin(req, id, dto) {
    ...
    async createApiKey(req, dto) {
        return this.usersService.createApiKey(req.user.sub, dto.name, dto.permissions);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, user_settings_dto_1.UpdateProfileDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, user_settings_dto_1.AdminUpdateUserDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Create API key for current user' }),
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "createApiKey", null);
